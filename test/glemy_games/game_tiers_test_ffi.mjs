// Test-only helper for game_tiers_test.gleam: creates a real OffscreenCanvas
// for glemy/game_tiers.tick_and_render to render onto -- same rationale as
// test/glemy/render_test_ffi.mjs (kept as its own small file per-test-file,
// matching this project's existing convention, e.g. io_test_ffi.mjs).
